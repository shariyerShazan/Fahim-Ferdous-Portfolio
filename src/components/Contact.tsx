    ...
    <section id="contact" className="py-24 px-6 min-h-screen flex flex-col justify-center">
      <div className="max-w-3xl mx-auto w-full">
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-16 flex items-center gap-4" data-aos="fade-right">
          <span className="text-[#00f0ff] font-mono text-2xl md:text-4xl">07.</span>
          Let's Connect
        ...
        <div className="bg-[#0f172a] rounded-xl p-8 border border-[#1e293b] shadow-2xl relative" data-aos="fade-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label htmlFor="inquiryType" className="text-sm font-mono text-[#94a3b8]">Inquiry Type</label>
                <select 
                  id="inquiryType" 
                  name="inquiryType" 
                  required
                  className="w-full bg-[#0a0f1d] border border-[#334155] rounded px-4 py-3 text-white focus:outline-none focus:border-[#00f0ff] transition-colors appearance-none"
                >
