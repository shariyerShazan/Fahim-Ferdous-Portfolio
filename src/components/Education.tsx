          ...
          {EDUCATION.map((edu, index) => (
            ...
            >
              ...
              <div className="flex-grow">
                ...
                <h4 className="text-lg text-[#00f0ff] mb-4">{edu.institution}</h4>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between text-sm font-mono text-[#94a3b8] gap-2">
                  ...
                  <div className="flex items-center gap-2 text-[#00f0ff] font-semibold bg-[#00f0ff]/10 px-3 py-1 rounded">
                    {edu.result}
                  </div>
                </div>
              </div>
